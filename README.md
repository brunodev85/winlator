...
Winlator is an Android application that lets you to run Windows (x86_32) applications with Wine and Box86/Box32.

# Installation

1. Download and install the APK (Winlator_5.1.1.apk) from [GitHub Releases](https://github.com/brunodev85/winlator/releases)
...
- Box86/Box32 by [ptitseb](https://github.com/ptitSeb)
